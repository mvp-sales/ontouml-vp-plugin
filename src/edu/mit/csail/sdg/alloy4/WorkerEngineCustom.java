...
public class WorkerEngineCustom {
                ...
                if (Util.onWindows()) {
                    if (jniPath!=null && jniPath.length()>0)
                        sub = Runtime.getRuntime().exec(new String[] {
                                ...
                                "-Ddebug=" + debug,
                                "-cp",
                                classPath+";"+AlloyType.class.getProtectionDomain().getCodeSource().getLocation().getPath(),
            ...
            latest_manager = new Thread(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        main2sub.writeObject(task); main2sub.close();
