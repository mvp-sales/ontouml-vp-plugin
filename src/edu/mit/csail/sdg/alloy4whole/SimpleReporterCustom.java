...
public class SimpleReporterCustom extends A4Reporter {

    public static final class SimpleCallback1 implements WorkerEngineCustom.WorkerCallbackCustom {
    ...
    private final WorkerEngineCustom.WorkerCallbackCustom cb;
    ...
    private SimpleReporterCustom(WorkerEngineCustom.WorkerCallbackCustom cb, boolean recordKodkod) { this.cb=cb; this.recordKodkod=recordKodkod; }
    ...
    static final class SimpleTask2 implements WorkerEngineCustom.WorkerTaskCustom {
        private static final long serialVersionUID = 0;
        public String filename = "";
        public transient WorkerEngineCustom.WorkerCallbackCustom out = null;
        private void cb(Object... objs) throws Exception { out.callback(objs); }
        public void run(WorkerEngineCustom.WorkerCallbackCustom out) throws Exception {
            this.out = out;
            cb("S2", "Enumerating...\n");
            A4Solution sol;
            Module mod;
    ...
    static final class SimpleTask1 implements WorkerEngineCustom.WorkerTaskCustom {
        private static final long serialVersionUID = 0;
        ...
        public SimpleTask1() { }
        public void cb(WorkerEngineCustom.WorkerCallbackCustom out, Object... objs) throws IOException { out.callback(objs); }
        public void run(WorkerEngineCustom.WorkerCallbackCustom out) throws Exception {
